...
/**
* Prog01_aOrderedList is the main class that gets file input and stores the cars data
* 
...
public class Prog01_aOrderedList {
	static aOrderedList<Car> orderedList;
	/**
	* Main method
	* 
	* CSC 1351 Programming Project No 1
	...
	*/
	...
	/**
	* Gets filename of output file and returns printwriter pointing to file name
	* 
	* CSC 1351 Programming Project No 1
	* Section 2
	* 
	...
	*/
	...
	/**
	* Reads the input file and adds car object to list
	* 
	* CSC 1351 Programming Project No 1
	* Section 2
	* 
